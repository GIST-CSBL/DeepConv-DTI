...
if __name__=="__main__":
    ...
    parser.add_argument("--without-label", "-W", help="Existence of label information in test DTI", action="store_true", default=False)
    ...
    without_label = not args.without_label
    ...
    test_dic = {test_name: parse_data(test_dti, test_drug, test_protein, with_label=without_label, **type_params)
    ...
    for dataset in test_dic:
        ...
        #value = predicted[dataset]["predicted"]
        #value = np.squeeze(value)
        print dataset+str(len(predicted))
